...
Процесс разработки новых функций для бота см. в [FLOW.md](docs/FLOW.md):

**User Story + Technical Design** - основной workflow для создания новых функций
...
- **TDD Documents** (`tdd/`) - Test-Driven Development спецификации и разработка
- **Templates** (`templates/`) - Шаблоны для создания новых требований
