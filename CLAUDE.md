...
5. **🚀 Новый flow работы:** [FLOW-NEW.md](docs/requirements/FLOW-NEW.md) - **ОБЯЗАТЕЛЬНО**
...
1. Копировать шаблон: docs/requirements/templates/feature-implementation-plan-template.md
...
**📖 Подробнее:** [FLOW-NEW.md](docs/requirements/FLOW-NEW.md) | [MIGRATION-PLAN.md](docs/requirements/MIGRATION-PLAN.md)
