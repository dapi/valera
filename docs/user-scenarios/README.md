# 📋 Пользовательские сценарии AI-ассистента Super Valera
...
- **[Customer Profiles](../product/customer-profiles.md)** — Профили клиентов для CustDev
- **[Product Constitution](../product/constitution.md)** — Конституция продукта
- **[System Prompt](../../data/system-prompt.md)** — Промпт AI-ассистента
