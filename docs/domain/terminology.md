# 🗣️ Терминология домена Super Valera
...
Этот документ определяет единый язык (Ubiquitous Language) для всех участников проекта Super Valera - от клиентов и менеджеров до разработчиков и AI-агентов. Использование консистентной терминологии критически важно для качества AI-взаимодействий и разработки.
...
| **AI-ассистент** | Цифровой консультант Супер Валера | Техническая документация, development | "AI-ассистент консультирует клиента" |
