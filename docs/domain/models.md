...
Этот документ описывает основные доменные модели AI-ассистента Super Valera, их атрибуты, поведения и взаимосвязи. Модели формализуют бизнес-сущности кузовного ремонта и обеспечивают основу для AI-понимания и разработки.
...
**Поведение:**
- Оценивается по стоимости и методам ремонта через диалог
