...
### Бизнес-проблема
Бот Super Valera находится в разработке и доступен в Telegram, но пользователи могут случайно найти его и подумать, что он работает в production режиме. Это создает риски:
