...
**Бизнес-цель**: Включить в функционал чат-бота Super Valera возможность запроса обратного звонка и записи на покрасочные/кузовные работы через естественный диалог, повышая конверсию и удовлетворенность клиентов.
...
**Технический подход**: Реализация через системные промпты в соответствии с Конституцией продукта Super Valera (только диалог, AI-first, логика через промпты).
