...
### Краткое описание
Автоматическая система приветствия новых пользователей в Telegram боте Валера с персонализированным сообщением и быстрыми действиями.
...
4. **Изучает возможности:** Читает о функциях бота и доступных командах
5. **Использует быстрые действия:** Нажимает кнопку для записи или уточнения цен
6. **Продолжает взаимодействие:** Переходит к основному функционалу бота

### Альтернативные сценарии
- **Возвращающийся пользователь:** Получает краткое re-welcome сообщение
- **Переключение между командами:** Может вернуться к главному меню в любой момент
...
4. Отправляется сообщение с inline клавиатурой
...
4. Предлагаются актуальные действия
...
- **Inline клавиатура:** 2-3 основные кнопки с понятными иконками и текстом
- **Меню команд:** Список доступных команд с кратким описанием

### Взаимодействие
- **Немедленный ответ:** Приветствие должно приходить в течение 2 секунд
- **Интуитивные кнопки:** Яркие, понятные призывы к действию
- **Контекстная помощь:** Возможность получить помощь в любой момент
...
### Успешность функции
- **Welcome message conversion:** 40% пользователей нажимают кнопку действия в течение 5 минут
...
- **События для отслеживания:**
  ...
  - `welcome_button_clicked`: Клик по кнопке в приветствии
...
- **Happy Path:** Новый пользователь → приветствие → клик по кнопке
...
- **Тест 3:** Проверка работы кнопок и навигации
