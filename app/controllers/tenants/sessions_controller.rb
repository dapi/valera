...
module Tenants
  ...
  class SessionsController < ApplicationController
    ...
    def create
      ...
      if owner.nil?
        flash.now[:alert] = I18n.t('tenants.sessions.no_owner')
      ...
      if owner.authenticate(params[:password])
        ...
        redirect_to tenant_root_path, notice: I18n.t('tenants.sessions.welcome')
      else
        flash.now[:alert] = I18n.t('tenants.sessions.invalid_password')
        render :new, status: :unprocessable_entity
      end
    end
    ...
    def destroy
      ...
      redirect_to new_tenant_session_path, notice: I18n.t('tenants.sessions.logged_out')
    end
  end
end
