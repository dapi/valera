...
| [docs/product/business-goals.md](docs/product/business-goals.md) | Бизнес-цели ПРОДУКТА (AI-бот), целевая аудитория продукта, метрики | 🟠 ВЫСОКИЙ |
...
| [DEVELOPMENT.md](DEVELOPMENT.md) | Руководство для разработчиков ПРОЕКТА Valera | Разработчики |
...
| Документ | Назначение |
|----------|-----------|
| [docs/docs-usage-metrics.md](docs/docs-usage-metrics.md) | Централизованные метрики использования всей документации |
| [docs/business-metrics.md](docs/business-metrics.md) | Бизнес-метрики и KPI AI-ассистента Valera |
...
1. **Бизнес-цели:** [docs/product/business-goals.md](docs/product/business-goals.md)
2. **Стратегия:** [docs/ROADMAP.md](docs/ROADMAP.md)
3. **Требования:** [docs/requirements/](docs/requirements/)
4. **Процесс:** [docs/FLOW.md](docs/FLOW.md)
5. **Архитектура:** [.claude/memory-bank.md](.claude/memory-bank.md)
...
📈 **[Метрики использования](docs/docs-usage-metrics.md#documentation_indexmd)** - см. централизованный документ метрик
