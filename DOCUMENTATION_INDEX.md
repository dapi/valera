...
| Документ | Назначение |
|----------|-----------|
| [docs/METRICS.md](docs/METRICS.md) | Централизованные метрики использования всей документации |
...
📈 **[Метрики использования](docs/METRICS.md#documentation_indexmd)** - см. централизованный документ метрик
